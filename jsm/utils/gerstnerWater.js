...
export default class GerstnerWater {
    ...
    constructor(gui) {
        ...
        this.texture = new THREE.TextureLoader().load('textures/water/waternormals.jpg', function (texture) {
        ...
        this.waves = [
          { direction: 0, steepness: 0.12, wavelength: 100 },
          { direction: 30, steepness: 0.12, wavelength: 50 },
          { direction: 60, steepness: 0.12, wavelength: 25 },
        ]
